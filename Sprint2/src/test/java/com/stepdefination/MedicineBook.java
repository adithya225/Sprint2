...
public class MedicineBook {
	//BookMedicines
		...
		public void homepage_is_open() {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\adprasad\\OneDrive - Capgemini\\Desktop\\Selenium\\drive\\chromedriver.exe");
		...
		public void user_enters_phone_number() throws InterruptedException {
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class=\"MuiButtonBase-root MuiFab-root MuiFab-primary\"]")));
			driver.findElement(By.xpath("//*[@class=\"MuiButtonBase-root MuiFab-root MuiFab-primary\"]")).click();
		}
		...
		public void user_clicks_on_add_to_cart() throws InterruptedException {
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div/div[2]/div[2]/div[2]/div[4]/div[1]/div/div[2]/button")).click();
			//Thread.sleep(5000);
	...
	public void user_enters_pincode_of_length_less_than_six_digits() {
    	...
    	//Thread.sleep(10000);
    	driver.findElement(By.xpath("/html/body/div[6]/div[3]/div/div/div[1]/div/input")).sendKeys("734001");
	...
	public void user_enters_the_cart_details() {
	    
	}

	@When("user enters pincode of length greater than six digits")
	public void user_enters_pincode_of_length_greater_than_six_digits() {
	...
	public void user_enters_the_order_details() {
	    
	}

	@When("user enters unavailable pincode services on address form")
	public void user_enters_unavailable_pincode_services_on_address_form() {
	...
	public void user_enters_the_details_of_medicine() {
	
	}

	@When("user enters valid pincode length on address form")
	public void user_enters_valid_pincode_length_on_address_form() {
	
	}

	@Then("the address details is saved")
	public void the_address_details_is_saved() {
