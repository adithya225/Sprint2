...
public class labtest {
	...
	public void user_can_access_lab_test_page() {
	...
	public void user_clicks_add_to_cart() {
	    driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[3]/div[2]/div/div[1]/div/div[1]/div/img")).click();
	    driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[1]/div[3]/div/div[1]/div/div/a")).click();
	    
	}

	@Then("Test is added to cart")
	public void test_is_added_to_cart() {
		driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[1]/div[3]/div/div[2]/div/div/div/div[2]/button/span[1]")).click();
		driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div[2]/div[1]/div[3]/div[1]/div/div[1]/div/div[4]/button/span[1]")).click();
	    boolean visible_text = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/div[5]/div[2]/div[1]")).isDisplayed();
	...
	public void user_clicks_on_view_details() {
	    driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[2]/div/div[2]/div[1]/span")).click();
	    boolean visible_box = driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[2]/div")).isDisplayed();
	    System.out.println(visible_box);
	}

	@Then("User can add recommended test to cart")
	public void user_can_add_recommended_test_to_cart() {
	    boolean reco = driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[2]/div/div[2]/ul[2]/h3")).isDisplayed();
	    System.out.println(reco);
	    driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[2]/div/div[2]/ul[2]/li[1]/div[2]/div[2]/button/span[1]")).click();
	    driver.quit();
	}

	@When("User clicks on remove test")
	public void user_clicks_on_remove_test() {
		driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[2]/div/div[2]/ul[1]/li[1]/div[2]/div[2]/button/span[1]")).click();
	}

	@Then("Test is removed from cart")
	public void test_is_removed_from_cart() {
	   String s1 = driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[2]/div[2]/div/div[1]/p")).getText();
	   String s2 = "2 Items added to your cart";
	...
	public void user_clicks_on_add_to_cart() {
	    boolean check = driver.findElement(By.xpath("//*[@id=\"mainContainerCT\"]/div[3]/div[1]/p")).isDisplayed();
